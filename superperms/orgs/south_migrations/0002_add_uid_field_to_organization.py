...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.uid'
        db.add_column(u'orgs_organization', 'uid',
                      self.gf('uuidfield.fields.UUIDField')(default=None, max_length=32, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.uid'
        db.delete_column(u'orgs_organization', 'uid')
    ...
    models = {
        ...
        u'orgs.organization': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'orgs'", 'symmetrical': 'False', 'through': u"orm['orgs.OrganizationUser']", 'to': u"orm['{0}']".format(user_orm_label)})
        },
