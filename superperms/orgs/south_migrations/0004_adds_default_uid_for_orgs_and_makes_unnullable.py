...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.uid'
        db.alter_column(u'orgs_organization', 'uid', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'Organization.uid'
        db.alter_column(u'orgs_organization', 'uid', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, null=True))
    ...
    models = {
        ...
        u'orgs.organization': {
            ...
            'uid': ('uuidfield.fields.UUIDField', [], {'default': "'7b730642-a098-4d5a-a0c9-2dd33a149875'", 'unique': 'True', 'max_length': '32', 'blank': 'True'}),
