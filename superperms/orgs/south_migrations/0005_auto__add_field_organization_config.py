...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.config'
        db.add_column(u'orgs_organization', 'config',
                      self.gf('djorm_pgjson.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.config'
        db.delete_column(u'orgs_organization', 'config')
    ...
    models = {
        ...
        u'orgs.organization': {
            ...
            'config': ('djorm_pgjson.fields.JSONField', [], {'default': '{}'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'uid': ('uuidfield.fields.UUIDField', [], {'default': "'28348aee-4b72-4042-8c43-2c6e6ecef592'", 'unique': 'True', 'max_length': '32', 'blank': 'True'}),
